...
{
    public partial class ArcSoftFaceDemoX32 : Form
    {
        ...
        byte[] captureFeature;
        byte[] personFeature;
        ArcSoft_FACE_API.FSDK_FACE_SHARE.MRECT[] rectX;                             //检测多个人脸使用
        ArcSoft_FACE_API.FSDK_FACE_DETECTION.AFD_FSDK_OrientCode[] lfaceOrientX;      //检测多个人脸使用

        //拖拽线程
        private Thread thread;


        public ArcSoftFaceDemoX32()
        {
            InitializeComponent();
        }
        ...
        private void DetectAndRecogition_Init()
        {
            ...
            retCode = ArcSoft_FACE_API.FSDK_FACE_DETECTION.AFD_FSDK_InitialFaceEngine(
                ArcSoft_FACE_API.FSDK_FACE_SHARE.app_Id_X32,
                ArcSoft_FACE_API.FSDK_FACE_SHARE.sdk_Key_FD_X32,
                pMemDetect,
            ...
            retCode = ArcSoft_FACE_API.FSDK_FACE_RECOGNITION.AFR_FSDK_InitialEngine(
                ArcSoft_FACE_API.FSDK_FACE_SHARE.app_Id_X32,
                ArcSoft_FACE_API.FSDK_FACE_SHARE.sdk_Key_FR_X32,
                pMemRecogition,
        ...
        private void ArcSoftFaceDemoX32_DragEnter(object sender, DragEventArgs e)
        {
        ...
        private void ArcSoftFaceDemoX32_FormClosing(object sender, FormClosingEventArgs e)
        { 
            Application.Exit();
            /*
